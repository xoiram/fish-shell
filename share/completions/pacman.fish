...
# Primary operations
complete -c pacman -s A -f -n '__fish_not_contain_opt -s D -s U -s Q -s R -s S -s h' -d 'Add a package to the system'
complete -c pacman -s D -f -n '__fish_not_contain_opt -s A -s U -s Q -s R -s S -s h' -d 'Modify the package database'
complete -c pacman -s U -f -n '__fish_not_contain_opt -s A -s D -s Q -s R -s S -s h' -d 'Upgrade or add a package in the system'
complete -c pacman -s Q -f -n '__fish_not_contain_opt -s A -s D -s U -s R -s S -s h' -d 'Query the package database'
complete -c pacman -s R -f -n '__fish_not_contain_opt -s A -s D -s U -s Q -s S -s h' -d 'Remove packages from the system'
complete -c pacman -s S -f -n '__fish_not_contain_opt -s A -s D -s U -s Q -s R -s h' -d 'Synchronize packages'
complete -c pacman -o V -f -d 'Display version and exit'

# General options
complete -c pacman -n '__fish_contains_opt -s A -s D -s Q -s R -s S -s U' -s d -d 'Skips all dependency checks'
complete -c pacman -n '__fish_contains_opt -s A -s D -s Q -s R -s S -s U' -s f -d 'Bypass file conflict checks'
complete -c pacman -n '__fish_contains_opt -s A -s D -s Q -s R -s S -s U' -s r -d 'Specify an alternative installation root'
complete -c pacman -n '__fish_contains_opt -s A -s D -s Q -s R -s S -s U' -s v -d 'Output more status messages'
complete -c pacman -n '__fish_contains_opt -s A -s D -s Q -s R -s S -s U' -l config -d 'Specify an altenate config file'
complete -c pacman -n '__fish_contains_opt -s A -s D -s Q -s R -s S -s U' -l noconfirm -d 'Bypass any question'
